...
langBtn.textContent = isEnglish ? "🇺🇸 EN" : "🇲🇽 ES";
  ...
  const translations = {
    ...
    "Earned a Bachelor´s degree in Business Management Engineering, blending business administration with process optimization and strategic planning.": "Obtuve el título de Ingeniería en Gestión empresarial, combinando administración de negocios con optimización de procesos y planificación estratégica.",
    ...
    "Maintained consistent academic performance and demonstrated responsibility in group assignments.": "Mantuve un rendimiento académico constante y demostrar responsabilidad en trabajos en grupo.",
    "Job Experience": "Experiencia Laboral",
    "Business Manager": "Gerente de Negocios",
    "Managed the full lifecycle of a web development project for a transportation company, from initial concept to final deployment.": "Gestione todo el ciclo de vida de un proyecto de desarrollo web para una empresa de transporte, desde el concepto inicial hasta el despliegue final.",
    "Coordinated with stakeholders to gather requirements, define objectives, and translate business needs into technical specifications.": "Coordine con las partes interesadas para recopilar requisitos, definir objetivos y traducir las necesidades empresariales en especificaciones técnicas.",
    "Oversaw a cross-functional team including developers, designers, and QA to ensure timely delivery and alignment with client expectations.": "Supervise un equipo multifuncional incluyendo desarrolladores, diseñadores y QA para garantizar la entrega a tiempo y la alineación con las expectativas del cliente.",
    "Implemented a user-friendly interface to streamline logistics tracking and improve operational efficiency across multiple departments.": "Implemente una interfaz fácil de usar para agilizar el seguimiento logístico y mejorar la eficiencia operativa en varios departamentos.",
    
    "Succesfully developed multiple web projects.": "Desarrolle de forma exitosa multiples proyectos web",
    "Engage with stakeholders to understand their needs, gather requirements, and analyze business processes to identify areas for improvement.": "Interactue con las partes interesadas para comprender sus necesidades, recopilar requisitos y analizar procesos empresariales para identificar áreas de mejora.",
    "Documented business requirements, functional specifications, user stories, and other project artifacts to ensure clear communication between stakeholders and development teams.": "Documente requisitos empresariales, especificaciones funcionales, historias de usuario y otros artefactos del proyecto para asegurar una comunicación clara entre las partes interesadas y los equipos de desarrollo.",
    "Provided knowledge, creativity and follow-up sessions with the development team to ensure accurate work and efficiency.": "Proporcione conocimientos, creatividad y sesiones de seguimiento con el equipo de desarrollo para garantizar un trabajo preciso y eficiente.",
    "Succesfully used Agile and Waterfall methodologies to accomodate necesities of different projects.": "Utilice con éxito metodologías Ágiles y en Cascada para adaptarse a las necesidades de diferentes proyectos.",
    "Collaborated with testing teams to define test cases, conduct testing, and ensure that deliverables meet quality standards and business requirements.": "Colabore con los equipos de pruebas para definir casos de prueba, realizar pruebas y asegurar que los entregables cumplan con los estándares de calidad y requisitos del negocio.",
    "Was part of an internal restructuring team for new HR department processes.": "Forme parte de un equipo de reestructuración interna para nuevos procesos del departamento de Recursos Humanos.",
    "Project coordinator": "Coordinador de Proyectos",
    "Ensured successful project execution according to established objectives, timelines and costs.": "Asegure la ejecución exitosa del proyecto de acuerdo con los objetivos, cronogramas y costos establecidos.",
    "Improved communication among all operations by 70%.": "Mejore la comunicación entre todas las operaciones en un 70%.",
    "Collaborated with salespeople to ensure projects and quotations were achievable.": "Colabore con vendedores para asegurar que los proyectos y presupuestos fueran viables.",
    "Processed and managed invoices and expenses.": "Procese y gestione facturas y gastos.",
    "Generated quality control programs for stakeholders.": "Genere programas de control de calidad para las partes interesadas.",
    "Worked with a commitment to precision and strong attention to detail": "Trabaje con compromiso a la precisión y gran atención al detalle",
    "Managed and supported business risk and worked to develop and implement strategic solutions.": "Gestione y apoye riesgos empresariales y trabajó en el desarrollo e implementación de soluciones estratégicas.",
    "Developed the business plan and finances.": "Desarrolle el plan de negocios y las finanzas.",
    "Brought forth the ability to multitask and prioritize.": "Demostre la capacidad de realizar múltiples tareas y priorizar responsabilidades.",
    "Drafted and formatted reports, presentations, and other documents.": "Redacte y formatie informes, presentaciones y otros documentos.",
    "Performed general office duties such as ordering supplies, maintaining office equipment and space.": "Realize tareas generales de oficina como pedir suministros, mantener el equipo y el espacio de oficina.",
    "Provided administrative support to other departments or executives as needed.": "Brinde apoyo administrativo a otros departamentos o ejecutivos según fuera necesario.",
    "Projects": "Proyectos",
